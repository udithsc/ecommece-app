          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Apartment, suite, unit etc. (Optional)</label>
                  <input 
                    type="text" 
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 sticky top-4">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="bank-transfer" className="ml-2 text-sm font-medium text-gray-700">
                  ...
                  <div className="flex items-center">
                    <input 
                      ...
                      className="text-primary focus:ring-[#629D23]"
                    />
                    <label htmlFor="check-payments" className="ml-2 text-sm font-medium text-gray-700">
                      Check payments
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input 
                      ...
                      className="text-primary focus:ring-[#629D23]"
                    />
                    <label htmlFor="cash-on-delivery" className="ml-2 text-sm font-medium text-gray-700">
                      Cash on delivery
                    </label>
                  </div>

...
import { AiOutlineMinus, AiOutlinePlus, AiFillStar, AiOutlineStar, AiOutlineHeart, AiOutlineShareAlt } from 'react-icons/ai';
...
const ProductDetail = ({ product, products }) => {
  const { image, name, details, price, originalPrice, rating, reviews, category, inStock, badges } = product;
  ...
  const relatedProducts = products?.filter(p => p.category === category && p._id !== product._id)?.slice(0, 4) || [];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 pt-4 border-t">
                ...
                >
                  <AiOutlineHeart className={`w-5 h-5 ${isInWishlist(product._id) ? 'fill-current' : ''}`} />
              ...
              {activeTab === 'description' && (
                <div className="prose max-w-none">
                  ...
                  <p className="text-gray-600 leading-relaxed mt-4">
                    This high-quality {name.toLowerCase()} is designed for professional use and everyday tasks. 
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-b pb-4">
                      ...
                      <p className="text-gray-600">Excellent product! Very satisfied with the quality and performance.</p>
                    </div>
                    <div className="border-b pb-4">
                      <div className="flex items-center space-x-2 mb-2">
                      ...
                      <p className="text-gray-600">Good value for money. Works as expected and shipping was fast.</p>
                    </div>
                  </div>
                </div>
              )}

...
type PaymentMethod = 'bank-transfer' | 'check-payments' | 'cash-on-delivery' | 'paypal';
...
const CheckoutForm: React.FC = () => {
  ...
  const [selectedPayment, setSelectedPayment] = useState<PaymentMethod>('bank-transfer');
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>): void => {
    ...
    if (type === 'checkbox') {
      ...
      setBillingData(prev => ({ ...prev, [name]: checked }));
    } else {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
    ...
    console.log('Processing order...', { billingData, selectedPayment, cartItems });
  };
